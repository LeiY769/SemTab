...
CONFIGS=(
    config/config_preprocessing_nollm.txt
    config/config_preprocessing_basic_prompt.txt
    config/config_preprocessing_qwen25_instruct_no_fewshot.txt
    config/config_preprocessing_qwen25_instruct.txt
    config/config_preprocessing_gemma.txt
    config/config_preprocessing_llama.txt
    config/config_preprocessing_qwen3_thinking.txt
    config/config_preprocessing_glm.txt
)
